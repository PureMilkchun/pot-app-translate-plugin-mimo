# XiaoMi MiMo Translation Plugin for Pot

基于小米 MiMo-V2-Flash 大模型的 Pot 翻译插件。

## 功能特性

- ✅ 支持小米 MiMo-V2-Flash 和 MiMo-V2 模型
- ✅ 支持多种语言互译
- ✅ 支持自定义 API 地址
- ✅ 简单易用的配置界面
- ✅ 深色模式适配图标
...
### 方法1：从 Release 下载（推荐）
1. 访问 [Releases 页面](https://github.com/pot-app/pot-app-translate-plugin-mimo/releases)
